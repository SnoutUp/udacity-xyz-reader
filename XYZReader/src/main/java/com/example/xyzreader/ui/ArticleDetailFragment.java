...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        collapsingToolbarLayout.setExpandedTitleTextAppearance(R.style.ToolbarTitleColor);
        collapsingToolbarLayout.setCollapsedTitleTextAppearance(R.style.ToolbarTitleColor);
    ...
    private void bindViews() {
        ...
        if (mToolbar != null) {
            ...
            mToolbar.setTitle(R.string.label_article);
        }
        ...
        mExpandButton = (Button)mRootView.findViewById(R.id.btn_expand);

        mExpandButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                bodyView.setMaxLines(0);
        ...
        if (mCursor != null) {
            ...
            /// A hacky way to avoid mid-sentence breaks and get nice paragraphs
            String bodyString = mCursor.getString(ArticleLoader.Query.BODY)
                    .replaceAll("(\r\n|\n)", "[br]")
                    .replaceAll("(\\[br\\]){2,}", "<br /><br />")
                    .replaceAll("\\[br\\]", "");
